<template>
	<view class="pageHomeWrap">
		...
		<view class="wonderfulNewWrap">
			<lay-out-wrap :title="'党员动态'" @onClick="goMore">
				<view slot="content">
...
<script>
	...
	export default {
		...
		methods: {
			...
			goMore() {
				linkTo('/pages/pageList/pageList?title=党员动态&category=party_dynamics&type=red')
			},
			goPage(id) {
				linkTo('/pages/pageDetail/pageDetail?id='+id+'&title=党员动态&type=red')
			},
